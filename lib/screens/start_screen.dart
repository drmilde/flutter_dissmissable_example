...
class _StartScreenState extends State<StartScreen> {
  ...
  List<Eintrag> liste = [
    ...
    Eintrag("Lilly",
        "https://upload.wikimedia.org/wikipedia/en/f/fe/Lily_aldrin.jpg"),
    Eintrag("Marshall",
        "https://upload.wikimedia.org/wikipedia/en/a/a6/Marshall_Eriksen.jpg"),
  ];
